...
func IntfArrToFloat64Arr(intfArr []interface{}) []float64 {
	floats := make([]float64, len(intfArr), len(intfArr))
...
func IntfArrToFloat32Arr(intfArr []interface{}) []float32 {
	floats := make([]float32, len(intfArr), len(intfArr))
	for idx, val := range intfArr {
...
func IntfArrToIntArr(intfArr []interface{}) []int {
	ints := make([]int, len(intfArr), len(intfArr))
	for idx, val := range intfArr {
		ints[idx] = val.(int)
	}
	return ints
...
func IntfArrToInt64Arr(intfArr []interface{}) []int64 {
	ints := make([]int64, len(intfArr), len(intfArr))
	for idx, val := range intfArr {
		ints[idx] = val.(int64)
	}
	return ints
...
func IntfArrToUint64Arr(intfArr []interface{}) []uint64 {
	ints := make([]uint64, len(intfArr), len(intfArr))
	for idx, val := range intfArr {
		ints[idx] = val.(uint64)
	}
	return ints
...
func IntArrToFloat64Arr(intArr []int) []float64 {
	floats := make([]float64, len(intArr), len(intArr))
